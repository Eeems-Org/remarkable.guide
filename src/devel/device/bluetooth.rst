...
The reMarkable 1 and 2 do not have bluetooth. The reMarkable Paper Pro, Paper Pro Move, and Paper Pure do have bluetooth hardware, but the driver is not loaded by default.
