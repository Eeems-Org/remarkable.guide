...
If you use a reMarkable 2, there is another tool that has been built on top of this that simplifies the process called `codexctl <https://github.com/Jayy001/codexctl>`_.
